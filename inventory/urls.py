...
from .views import (
    ...
    order_request, forecast_supplier_demands, supplier_ratings, rate_order, mark_delivered
)
...
urlpatterns = [
    ...
    path('dashboard/supplier/mark_delivered/<int:order_id>/', mark_delivered, name='mark_delivered'),
]
