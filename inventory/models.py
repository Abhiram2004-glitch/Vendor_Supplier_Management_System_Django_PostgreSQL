...
class ListCommodity(models.Model):
    ...
    is_custom = models.BooleanField(default=False)  # Flag for custom commodities
    created_by = models.ForeignKey(User, null=True, blank=True, on_delete=models.SET_NULL)  # Track who created custom commodities
...
class Order(models.Model):
    ...
    delivery_address = models.TextField(blank=True)  # Store vendor's address at time of order
    expected_delivery_date = models.DateField(null=True, blank=True)
    delivery_notes = models.TextField(blank=True)  # For supplier to add delivery instructions
